...
class PrivatePolicy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _controller = Get.find<PrivatePolicyController>();
    _controller.textEditingController.text = _controller.privatePolicyModel.value.content!;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Padding(
          ...
          child: IconButton(
            onPressed: () => _controller.updatePolicy(), 
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              // child: Text('data'),
              child: Text('最後更新日期 : ${DateFormat('yyyy年MM月dd日').format(DateTime.fromMicrosecondsSinceEpoch(_controller.privatePolicyModel.value.lastModify!.microsecondsSinceEpoch))}'),
            ),
