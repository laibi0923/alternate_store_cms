...
class RefundPolicy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _controller = Get.find<RefundPolicyController>();
    _controller.textEditingController.text = _controller.refundPolicyModel.value.content!;
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text('最後更新日期 : ${DateFormat('yyyy年MM月dd日').format(DateTime.fromMicrosecondsSinceEpoch(_controller.refundPolicyModel.value.lastModify!.microsecondsSinceEpoch))}'),
            ),
